...
tweets = []
# limit = 100
str = "식중독 since:" + yesterday.strftime('%Y-%m-%d')
...
df.to_csv('food_poisoning_today.csv')
df.to_sql(name='food_poisoning_input', con=db_connection, if_exists='replace', index=False)
