...
tweets = []
# limit = 100
str = "피부병 since:" + yesterday.strftime('%Y-%m-%d')
...
df.to_csv('skin_disease_today.csv')
df.to_sql(name='skin_disease_input', con=db_connection, if_exists='replace', index=False)